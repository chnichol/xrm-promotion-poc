...
interface Entity_AttributeCollection extends Collection<Attribute_statuscode | Attribute_cr35b_sapling_name | Attribute_ownerid | Attribute_createdon> {
    get(): (Attribute_statuscode | Attribute_cr35b_sapling_name | Attribute_ownerid | Attribute_createdon)[];
    get(index: number): (Attribute_statuscode | Attribute_cr35b_sapling_name | Attribute_ownerid | Attribute_createdon);
    get(predicate: (value: Attribute_statuscode | Attribute_cr35b_sapling_name | Attribute_ownerid | Attribute_createdon, index: number) => boolean): (Attribute_statuscode | Attribute_cr35b_sapling_name | Attribute_ownerid | Attribute_createdon)[];
    getLength(): 4;
...
interface UI_ControlCollection extends Collection<Control_statuscode | Control_cr35b_sapling_name | Control_ownerid | Control_createdon> {
    get(): (Control_statuscode | Control_cr35b_sapling_name | Control_ownerid | Control_createdon)[];
    get(index: number): (Control_statuscode | Control_cr35b_sapling_name | Control_ownerid | Control_createdon);
    get(predicate: (value: Control_statuscode | Control_cr35b_sapling_name | Control_ownerid | Control_createdon, index: number) => boolean): (Control_statuscode | Control_cr35b_sapling_name | Control_ownerid | Control_createdon)[];
    getLength(): 4;
    get(name: 'statuscode'): Control_statuscode;
    get(name: 'cr35b_sapling_name'): Control_cr35b_sapling_name;
    get(name: 'ownerid'): Control_ownerid;
...
interface UI_Tab0_Section2_ControlCollection extends Collection<Control_cr35b_sapling_name> {
    get(): [Control_cr35b_sapling_name];
    get(predicate: (value: Control_cr35b_sapling_name, index: number) => boolean): (Control_cr35b_sapling_name)[];
    getLength(): 1;
    get(index: number): never;
