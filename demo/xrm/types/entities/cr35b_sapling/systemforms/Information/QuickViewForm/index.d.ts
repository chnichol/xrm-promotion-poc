...
interface Entity_AttributeCollection extends Collection<Attribute_cr35b_sapling_name | Attribute_ownerid> {
    get(): (Attribute_cr35b_sapling_name | Attribute_ownerid)[];
    get(index: number): (Attribute_cr35b_sapling_name | Attribute_ownerid);
    get(predicate: (value: Attribute_cr35b_sapling_name | Attribute_ownerid, index: number) => boolean): (Attribute_cr35b_sapling_name | Attribute_ownerid)[];
    getLength(): 2;
...
interface UI_ControlCollection extends Collection<Control_cr35b_sapling_name | Control_ownerid> {
    get(): (Control_cr35b_sapling_name | Control_ownerid)[];
    get(index: number): (Control_cr35b_sapling_name | Control_ownerid);
    get(predicate: (value: Control_cr35b_sapling_name | Control_ownerid, index: number) => boolean): (Control_cr35b_sapling_name | Control_ownerid)[];
    getLength(): 2;
    get(name: 'cr35b_sapling_name'): Control_cr35b_sapling_name;
    get(name: 'ownerid'): Control_ownerid;
}

interface UI_Tab0_Section0_ControlCollection extends Collection<Control_cr35b_sapling_name | Control_ownerid> {
    get(): [Control_cr35b_sapling_name, Control_ownerid];
    get(predicate: (value: Control_cr35b_sapling_name | Control_ownerid, index: number) => boolean): (Control_cr35b_sapling_name | Control_ownerid)[];
    getLength(): 2;
