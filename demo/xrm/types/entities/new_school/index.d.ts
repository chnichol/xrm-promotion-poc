export default interface new_school {
    ...
    /** @readonly */
    readonly new_addressstatename: any;
    /**
     * Street number and name for the school address.
     * @display Address Street
     */
    new_addressstreet: string;
    /** @display Address Time Zone */
    ...
    /**
     * Last Updated time of rollup field Planted Saplings.
     * @display Planted Saplings (Last Updated On)
     * @readonly
     */
    readonly new_plantedsaplings_date: Date;
    /**
     * State of rollup field Planted Saplings.
     * @display Planted Saplings (State)
     * @readonly
     */
